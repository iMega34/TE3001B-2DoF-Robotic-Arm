...
class CinematicaInversa(Node):
    ...
    def ik_callback(self, request, response):
        ...
        if y < 0:
            ...
            response.theta1 = int(-1000)
            response.theta2 = int(-1000)
            return response
        ...
        if theta1 is None or theta2 is None:
            ...
            response.theta1 = int(-1000)  # Usar -1 como valor de error
            response.theta2 = int(-1000)  # Usar -1 como valor de error
            return response
    ...
    def calculate_inverse_kinematics(self, x, y):
        ...
        if r > (self.L1 + self.L2) or r < abs(self.L1 - self.L2):
            self.get_logger().info(f"Valores calculados 1 : theta1={theta1}, theta2={theta2}")
        ...
        if abs(cos_theta2) > 1:
            self.get_logger().info(f"Valores calculados 2 : theta1={theta1}, theta2={theta2}")
        ...
        if theta1 < -90 or theta1 > 90:
            self.get_logger().info(f"Valores calculados 3 : theta1={theta1}, theta2={theta2}")
